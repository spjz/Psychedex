...
class ExperienceIndex extends \Phalcon\Mvc\Model
{
	...
	public function initialize()
	{
		$this->hasMany(
			'id',
			'Psychedex\Models\Entities\ExperienceComments',
			'experience_index_id',
			['alias' => 'ExperienceComments']
		);
		$this->hasMany(
			'id',
			'Psychedex\Models\Entities\ExperienceEffects',
			'experience_index_id',
			['alias' => 'ExperienceEffects']
		);
		$this->hasMany(
			'id',
			'Psychedex\Models\Entities\ExperiencePhysiology',
			'experience_index_id',
			['alias' => 'ExperiencePhysiology']
		);
		$this->hasMany(
			'id',
			'Psychedex\Models\Entities\ExperienceReport',
			'experience_index_id',
			['alias' => 'ExperienceReport']
		);
		$this->hasMany(
			'id',
			'Psychedex\Models\Entities\ExperienceSociology',
			'experience_index_id',
			['alias' => 'ExperienceSociology']
		);
		$this->hasMany(
			'id',
		...
		$this->hasMany(
			'id',
			'Psychedex\Models\Entities\ExperienceTags',
			'experience_index_id',
			['alias' => 'ExperienceTags']
		);
		$this->hasMany(
			'id',
			'Psychedex\Models\Entities\ExperienceVisibility',
			'experience_index_id',
			['alias' => 'ExperienceVisibility']
		);
		$this->belongsTo(
			'user_index_id',
