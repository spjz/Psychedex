...
class EffectIndex extends \Phalcon\Mvc\Model
{
	...
	public function initialize()
	{
		$this->hasMany(
			'id',
			'Psychedex\Models\Entities\EffectArticles',
			'effect_index_id',
			['alias' => 'EffectArticles']
		);
		$this->hasMany(
			'id',
			'Psychedex\Models\Entities\EffectClasses',
			'effect_index_id',
			['alias' => 'EffectClasses']
		);
		$this->hasMany(
		...
		$this->belongsTo(
			'effect_domain_id',
			'Psychedex\Models\Entities\EffectDomains',
			'id',
			['alias' => 'EffectDomains']
		);
		$this->belongsTo(
			'effect_transformation_id',
			'Psychedex\Models\Entities\EffectTransformations',
			'id',
			['alias' => 'EffectTransformations']
		);
	}
