...
class MoleculePharmacologyLigands extends \Phalcon\Mvc\Model
{
    ...
    public function initialize()
    {
        ...
        $this->belongsTo('pharmacology_activity_id', 'Psychedex\Models\Entities\PharmacologyActivity', 'id', ['alias' => 'PharmacologyActivity']);
        $this->belongsTo('pharmacology_receptor_id', 'Psychedex\Models\Entities\PharmacologyReceptors', 'id', ['alias' => 'PharmacologyReceptors']);
    }
