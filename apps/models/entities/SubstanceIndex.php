...
class SubstanceIndex extends \Phalcon\Mvc\Model
{
	...
	public function initialize()
	{
		...
		$this->hasMany(
			'id',
			'Psychedex\Models\Entities\SubstanceArticles',
			'substance_index_id',
			['alias' => 'SubstanceArticles']
		);
		$this->hasMany(
			'id',
			'Psychedex\Models\Entities\SubstanceConstituents',
			'substance_index_id',
			['alias' => 'SubstanceConstituents']
		);
		$this->hasMany(
			'id',
			'Psychedex\Models\Entities\SubstanceIdentifiers',
			'substance_index_id',
			['alias' => 'SubstanceIdentifiers']
		);
		$this->hasMany(
			'id',
