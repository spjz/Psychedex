...
class UserPreferences extends \Phalcon\Mvc\Model
{
     ...
     * @return $this
     */
    public function setVisibilityExperiencePhysiology($visibility_experience_physiology)
    {
     ...
     * @return $this
     */
    public function setVisibilityExperienceSociology($visibility_experience_sociology)
    {
