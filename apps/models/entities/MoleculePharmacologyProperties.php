...
class MoleculePharmacologyProperties extends \Phalcon\Mvc\Model
{
     ...
     * @Column(type="integer", length=11, nullable=false)
     */
    protected $pharmacology_property_id;
    ...
    /**
     * Method to set the value of field pharmacology_property_id
     *
     * @param integer $pharmacology_property_id
     * @return $this
     */
    public function setPharmacologyPropertyId($pharmacology_property_id)
    {
        $this->pharmacology_property_id = $pharmacology_property_id;
    ...
    /**
     * Returns the value of field pharmacology_property_id
     *
     * @return integer
     */
    public function getPharmacologyPropertyId()
    {
        return $this->pharmacology_property_id;
    }
    ...
    public function initialize()
    {
        ...
        $this->belongsTo('pharmacology_property_id', 'Psychedex\Models\Entities\PharmacologyProperties', 'id', ['alias' => 'PharmacologyProperties']);
    }
    ...
    {
        return 'molecule_pharmacology_properties';
    }
     ...
     * @return MoleculePharmacologyProperties[]
     */
    ...
    public function columnMap()
    {
        return [
            ...
            'pharmacology_property_id' => 'pharmacology_property_id',
