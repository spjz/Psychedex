...
class UserIndex extends \Phalcon\Mvc\Model
{
    ...
    public function validation()
    {
	    ...
	    $validation
		    ->add(['hash','public_key','private_key','timestamp_created'], new Validation\Validator\PresenceOf())
		    ->add(['hash','name'], new Validation\Validator\Uniqueness())
		    ->add('email', new Validation\Validator\Email())
		    ->add(['phone_code','phone_number'], new Validation\Validator\Numericality())
		    ->add('timestamp_created', new Validation\Validator\Date(['format' => 'Y-m-d H:i:s'])
		    );
